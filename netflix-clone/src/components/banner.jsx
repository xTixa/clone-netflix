    ...
    <section className="relative h-[62vh] w-full bg-gradient-to-tr from-zinc-900 via-transparent to-zinc-900 flex items-end">
      ...
      <div className="container relative pb-12">
        <div className="max-w-[720px]">
          <h2 className="text-4xl md:text-6xl font-extrabold mb-4">Séries e filmes em destaque</h2>
          <p className="text-sm md:text-base text-white/80 mb-6">Assista onde quiser. Comece a ver hoje mesmo.</p>
